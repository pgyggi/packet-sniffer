...
import (
	...
	"github.com/PengLiu/beats/libbeat/common"
	"github.com/PengLiu/beats/libbeat/logp"
	"github.com/PengLiu/beats/packetbeat/protos"
	"github.com/PengLiu/beats/packetbeat/publish"

	// import plugins for testing
	_ "github.com/PengLiu/beats/packetbeat/protos/http"
	_ "github.com/PengLiu/beats/packetbeat/protos/mysql"
	_ "github.com/PengLiu/beats/packetbeat/protos/redis"
